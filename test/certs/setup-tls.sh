...
openssl x509 -req -in broker.csr.pem -CA ca.cert.pem -CAkey ca.key.pem -CAcreateserial -out broker.cert.pem -days 3650 -extensions v3_ext -extfile ../broker.conf -sha256
